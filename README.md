...
## the scene
The scene represents somewhat of a level in your game. It contains all the elements that define your project for this specific level: gameobjects, environments, UI elements, special effects etc. One Unity project can contain main scenes but you only have one active scene at a time taht you can work on. However your build project can contain a sequence of scenes that the player/user movers through. 
